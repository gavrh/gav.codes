		...
		<ExperienceContainer>
			<div className="flex">
				<img
					alt={position}
					src={image}
					className="sm:block hidden dark:brightness-[80%] bg-white rounded-lg w-[70px] h-[70px]  mr-[10px]"
				/>
				<div className="mt-[-4px]">
					<h1 className="font-semibold dark:text-gray-300 text-zinc-700 text-xl">
						{position}
					</h1>
					<h1 className="font-semibold dark:text-gray-500 text-zinc-500">
						{setting}
					</h1>
					<h1 className="font-semibold dark:text-gray-500 text-zinc-500">
						{time}
			...
			<h1 className="sm:block hidden text-lg dark:text-gray-400 text-zinc-600 mt-[10px]">
				{bio}
			</h1>
			<h1 className="sm:hidden block text-lg dark:text-gray-400 text-zinc-600 mt-[10px]">
				{bioShort}
			</h1>
		</ExperienceContainer>
	);
