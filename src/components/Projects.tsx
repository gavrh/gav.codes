...
function Project(props: { repo: string, desc: string, lang: string, color: string }) {
        ...
        <ProjectContainer to={`https://github.com/gavrh/${props.repo}`} target="_blank">
            ...
            <ProjectBottom>
                <div className="flex items-center">
                    <div className="w-[12px] h-[12px] rounded-full mr-[7px]" style={{ backgroundColor: props.color }} />
